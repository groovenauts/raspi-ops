    ...
    try:
        while runningFlag:
            ...
            for f in files:
                ...
                subprocess.call("tshark -l -r '{}' -Y 'wlan.fc.type_subtype != 0x08' -T fields -E separator=',' -e frame.time_epoch -e wlan.sa -e radiotap.dbm_antsignal > '{}'".format(f, csv_file), shell=True)
